...
dropped, leaving a zero-sentinel buffer. (This is exactly how dropping GEOSFP `A1₊PBLH`,
read solely by `PBLMixingCallback`, silently disabled PBL mixing and collapsed surface O₃.)
